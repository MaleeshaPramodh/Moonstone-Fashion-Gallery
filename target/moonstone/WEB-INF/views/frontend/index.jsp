...
<div class="body" id="body">
    ...
    <div class="div-body1">
        <div class="video-div2">
            ...
            <video width="250" height="480" src="videos/Facebook%20video%202813637768773544.mp4" style="margin-top: -2vh;"
                   autoplay loop muted/>
        </div>
        <div class="video-div3">
            <div class="text-div"><h1>Limited Edition !</h1></div>
            <video width="250" height="480" src="videos/Facebook%20video%20651517226781342.mp4" class="video2" autoplay loop
                   muted/>
        </div>
    </div>
